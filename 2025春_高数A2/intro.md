...
> ==本学期的学习任务==
>
> 上学期我们学习了**(一元)函数的微积分**, 学会了运用微积分这个强大的数学工具去求*`函数的极值`*, *`椭圆的面积`*, *`心形线的长度`*, *`通过牛顿定律推导简谐振动方程`*等等, 在这个过程中, 我们锻炼了解决实际问题的能力, 更重要的是通过数学改变了我们对世界的认识(或多或少).
> 
> 本学期我们将延续这一壮美的旅程, 主要内容是**多元函数的微积分**. 熟练的**处理多元函数**的技能能够大大扩展我们解决实际问题的能力. 多元微积分的很多结论和性质都是一元微积分的推广, 但同时多元微积分里又有很多新问题和新方法. 因此在本学期的学习中, 我们需要特别注重一元微积分和多元微积分之间的**联系**和**区别**. 
> 
> 总的来说, 在接下来的课程里, 希望大家以**基本原理和定义**为准绳, 不断扩展和更新我们的**数学直觉**, 理解并掌握多元微积分的**数学工具**, 并将其灵活应用于**解决实际问题**.
...
> ==参考书目:==
>
> - 《高等数学》(第七版)下册， 同济大学数学教研组主编，高等教育出版社.
